<template>
  <div id="landing-page" class="h-screen flex flex-col justify-center items-center bg-pink-500">
    ...
    <section class="text-white text-center mb-8">
      <h1 class="text-5xl font-bold mb-4">Welcome to TheCraftShack</h1>
      <!-- Add the image under the title -->
      <img src="/path/to/your/image.jpg" alt="Welcome Image" class="max-w-xs mb-4">
    ...
    <section class="text-white text-center mb-8">
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div class="p-4 border rounded-lg shadow-lg">
          <img src="/path/to/product1.jpg" alt="Product 1" class="w-full mb-2">
          <h3 class="text-lg font-semibold">Product 1</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
        </div>
        <div class="p-4 border rounded-lg shadow-lg">
          <img src="/path/to/product2.jpg" alt="Product 2" class="w-full mb-2">
