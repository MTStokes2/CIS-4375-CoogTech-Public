...
router.post('/Products', upload.single('ProductImage'), async (req, res) => {
    try {
        ...
        if (uploadResult.$metadata.httpStatusCode === 200) {
            ...
            // Here you should retrieve the URL of the uploaded image, depending on your S3 bucket configuration.
            // This can vary if you're using S3 static hosting or if you need a signed URL.
