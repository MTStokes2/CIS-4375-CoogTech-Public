...
//                State Model                        //
//---------------------------------------------------//
const State_Model = database.define(
  'STATE',
  {
    StateID: {
...
//                 City Model                        //
//---------------------------------------------------//
const City_Model = database.define(
  'CITY',
  {
    CityID: {
      type: Sequelize.INTEGER,
...
//             Customers Model                        //
//---------------------------------------------------//
const Customers_Model = database.define(
  'CUSTOMERS',
  {
    CustomerID: {
      type: Sequelize.INTEGER,
...
//               Admins Model                        //
//---------------------------------------------------//
const Admins_Model = database.define(
  'ADMINS',
  {
    AdminID: {
      type: Sequelize.INTEGER,
...
//             Usernames Model                       //
//---------------------------------------------------//
const Usernames_Model = database.define(
  'USERNAMES',
  {
    UsernameID: {
      type: Sequelize.INTEGER,
...
//             Passwords Model                       //
//---------------------------------------------------//
const Passwords_Model = database.define(
  'PASSWORDS',
  {
    PasswordID: {
      type: Sequelize.INTEGER,
...
//                Status Model                       //
//---------------------------------------------------//
const Status_Model = database.define(
  'STATUS',
  {
    StatusID: {
      type: Sequelize.INTEGER,
...
//                Orders Model                       //
//---------------------------------------------------//
const Orders_Model = database.define(
  'ORDERS',
  {
    OrderID: {
      type: Sequelize.INTEGER,
...
//             Custom Orders Model                   //
//---------------------------------------------------//
const Custom_Orders_Model = database.define(
  'CUSTOM_ORDERS',
  {
    CustomOrderID: {
      type: Sequelize.INTEGER,
...
//             Products Model                        //
//---------------------------------------------------//
const Products_Model = database.define(
  'PRODUCTS',
  {
    ProductID: {
      type: Sequelize.INTEGER,
...
//---------------------------------------------------//
const Order_Products_Model = database.define(
  'ORDER_PRODUCTS',
  {
    OrderProductsID: {
      type: Sequelize.INTEGER,
...
//                Reports Model                      //
//---------------------------------------------------//
const Reports_Model = database.define(
  'REPORTS',
  {
    ReportID: {
      type: Sequelize.INTEGER,
...
//                Chat Model                         //
//---------------------------------------------------//
const Chat_Model = database.define(
  'CHAT',
  {
    ChatID: {
      type: Sequelize.INTEGER,
...
//           Customer Chat Model                     //
//---------------------------------------------------//
const Customer_Chat_Model = database.define(
  'CUSTOMER_CHAT',
  {
    CustomerChatID: {
      type: Sequelize.INTEGER,
...
//              Admin Chat Model                     //
//---------------------------------------------------//
const Admin_Chat_Model = database.define(
  'ADMIN_CHAT',
  {
    AdminChatID: {
      type: Sequelize.INTEGER,
...
//---------------------------------------------------//
const Custom_Products_Model = database.define(
  'CUSTOM_PRODUCTS',
  {
    CustomProductID: {
      type: Sequelize.INTEGER,
...
//---------------------------------------------------//
const Custom_Products_Order_Model = database.define(
